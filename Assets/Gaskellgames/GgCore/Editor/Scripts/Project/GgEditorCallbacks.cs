...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgEditorCallbacks : AssetPostprocessor, ISerializationCallbackReceiver
    {
        ...
        #region Variables: PrefabOpened
        
        /// <summary>
        /// Called when a prefab is opened.
        /// </summary>
        public static event OnPrefabOpenedDelegate OnPrefabOpened;
        public delegate void OnPrefabOpenedDelegate(GameObject rootGameObject, SceneData sceneData);
        ...
        private static void ObjectChangeEvents_ChangeGameObjectParent(ref ObjectChangeEventStream stream, int index)
        {
            ...
            if (!newParentGo) { return; }
            if (!previousParentGo) { return; }
        ...
        private static void  ObjectChangeEvents_ChangeGameObjectOrComponentProperties(ref ObjectChangeEventStream stream, int index)
        {
            ...
            switch (goOrComponent)
            {
                ...
                case Component component:
                    ...
                    DebugLog("OnGameObjectPropertiesUpdated: component {0} on gameObject {1}", component.GetType(), component.gameObject.name);
                    break;
            }
        }
        ...
        #region Private Functions: OnPrefabOpened
        ...
        private static async void PrefabStage_OnPrefabStageOpened(PrefabStage prefabStage)
        {
            ...
            if (scene.IsValid())
            {
                OnPrefabOpened?.Invoke(prefabStage.prefabContentsRoot, new SceneData(scene));
            }
        }
