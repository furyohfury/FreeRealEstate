...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GaskellgamesHubSettings_SO : GgScriptableObject
    {
        ...
        [SerializeField, ReadOnly]
        internal HierarchyBreadcrumbOptions showHierarchyBreadcrumbs = HierarchyBreadcrumbOptions.Always;
        ...
        [SerializeField, ReadOnly]
        private ShowGaskellgamesLogs showGgLogs = ShowGaskellgamesLogs.Always;

        internal ShowGaskellgamesLogs ShowGgLogs
        {
            get => showGgLogs;
            set
            {
                showGgLogs = value;
                GgLogs.logsEnabled = value == ShowGaskellgamesLogs.Always;
            }
        }
