...
namespace Game
{
	public sealed class KeysInputNotesObservable : IInitializable, IDisposable, IInputNotesObservable
	{
		...
		public KeysInputNotesObservable(InputActions inputActions)
		{
