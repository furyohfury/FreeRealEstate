...
namespace Game.Application.Ads.Observers
{
    public sealed class ItemConsumeAnalyticsObserver : MonoBehaviour
    {
        ...
        {
            AnalyticsService.Instance.SendEvent(AnalyticsEvents.RIGHT_COLOR_ITEM_CONSUMED);
        }

        private void OnWrongColorItemConsumed(Item _)
        {
            AnalyticsService.Instance.SendEvent(AnalyticsEvents.WRONG_COLOR_ITEM_CONSUMED);
        }
